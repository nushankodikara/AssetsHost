...
},{"process":"../node_modules/process/browser.js"}],"style.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
// Hover Effect
(0, _jquery.default)(".animationTrigger:nth-child(1), .subElementCategory:nth-child(1)").mouseenter(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(1)",
    translateX: "-50%",
    translateY: "-50%",
    scale: 1.2
  });
  (0, _animejs.default)({
    targets: ".subElementStatic:nth-child(1)",
    opacity: 0
  });
  (0, _animejs.default)({
    targets: ".subElementCategory:nth-child(1)",
    opacity: 1
  });
});
(0, _jquery.default)(".animationTrigger:nth-child(1), .subElementCategory:nth-child(1)").mouseleave(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(1)",
    translateX: "-50%",
    translateY: "-50%",
...
(0, _jquery.default)(".animationTrigger:nth-child(2), .subElementCategory:nth-child(2)").mouseenter(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(2)",
    translateX: "-50%",
    translateY: "-50%",
    scale: 1.2
  });
  (0, _animejs.default)({
    targets: ".subElementStatic:nth-child(2)",
    opacity: 0
  });
  (0, _animejs.default)({
    targets: ".subElementCategory:nth-child(2)",
    opacity: 1
  });
});
(0, _jquery.default)(".animationTrigger:nth-child(2), .subElementCategory:nth-child(2)").mouseleave(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(2)",
    translateX: "-50%",
    translateY: "-50%",
...
(0, _jquery.default)(".animationTrigger:nth-child(3), .subElementCategory:nth-child(3)").mouseenter(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(3)",
    translateX: "-50%",
    translateY: "-50%",
    scale: 1.2
  });
  (0, _animejs.default)({
    targets: ".subElementStatic:nth-child(3)",
    opacity: 0
  });
  (0, _animejs.default)({
    targets: ".subElementCategory:nth-child(3)",
    opacity: 1
  });
});
(0, _jquery.default)(".animationTrigger:nth-child(3), .subElementCategory:nth-child(3)").mouseleave(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(3)",
    translateX: "-50%",
    translateY: "-50%",
...
(0, _jquery.default)(".animationTrigger:nth-child(4), .subElementCategory:nth-child(4)").mouseenter(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(4)",
    translateX: "-50%",
    translateY: "-50%",
    scale: 1.2
  });
  (0, _animejs.default)({
    targets: ".subElementStatic:nth-child(4)",
    opacity: 0
  });
  (0, _animejs.default)({
    targets: ".subElementCategory:nth-child(4)",
    opacity: 1
  });
});
(0, _jquery.default)(".animationTrigger:nth-child(4), .subElementCategory:nth-child(4)").mouseleave(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(4)",
    translateX: "-50%",
    translateY: "-50%",
...
(0, _jquery.default)(".animationTrigger:nth-child(5), .subElementCategory:nth-child(5)").mouseenter(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(5)",
    translateX: "calc( -50% + 1rem )",
    translateY: "-50%",
    scale: 1
  });
});
(0, _jquery.default)(".animationTrigger:nth-child(5), .subElementCategory:nth-child(5)").mouseleave(function () {
  (0, _animejs.default)({
    targets: ".elementStatic:nth-child(5)",
    translateX: "calc( -50% + 0rem )",
    translateY: "-50%",
    scale: 1
  });
}); // Hover Text Event

(0, _jquery.default)("#catIcon01").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Chemicals</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Housekeeping And Laundry</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Public area cleanning chemicals</li>\n        <li>Room and bathroom cleanning chemicals</li>\n        <li>Laundry chemicals</li>\n        <li>Stain removal chemicals</li>\n        <li>Furnicher and floor care</li>\n        <li>Carpet care</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon02").on("mouseover", function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Chemicals</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Engineering</h6>\n\t<p class=\"card-text\">\n\t<ul>\n\t\t<li>STP Chemicals</li>\n\t\t<li>Drain and Grease management</li>\n\t\t<li>Boiler Chemicals</li>\n\t\t<li>Drinking water plant chemicals</li>\n\t\t<li>Cooling tower chemicals</li>\n\t\t<li>Lubricants and oils</li>\n\t\t<li>Swimming pool chemicals</li>\n\t</ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon03").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Chemicals</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Food And Beverages</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Dishwash chemicals</li>\n        <li>Food contact surface cleanning chemicals</li>\n        <li>Utensils cleaning chemicals</li>\n        <li>Equipment cleanning chemicals</li>\n        <li>Workfloor cleanning chemicals</li>\n        <li>Perssonel hygiene chemicals</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon04").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Laboratory Service</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Food</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Physical</li>\n        <li>Chemical</li>\n        <li>Microbiological</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon05").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Laboratory Service</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Water</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Physical</li>\n        <li>Chemical</li>\n        <li>Microbiological</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon06").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Utensils And Equipments</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Bins and baskets</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Garbage Bins</li>\n        <li>Mop Buckets</li>\n        <li>Housekeeping trolly</li>\n        <li>Spray bottles</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon07").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Utensils And Equipments</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Cleaning Equipments</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Mops, brooms and brushes</li>\n        <li>Cloaths and pads</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon08").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Utensils And Equipments</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Safety And Hygeine</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Thermometers and data loggers</li>\n        <li>Rapid test kits</li>\n        <li>PPE and spill kits</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon09").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Paper</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Tissues</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Tissue rolls</li>\n        <li>Kitchen towels</li>\n        <li>Napkins</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)("#catIcon10").mouseenter(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Paper</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Food Safety</h6>\n\t<p class=\"card-text\">\n\t<ul>\n        <li>Temperature strips</li>\n        <li>Foodsafety tables</li>\n        <li>Test strips</li>\n    </ul>\n\t</p>");
});
(0, _jquery.default)(".subElementCategory").mouseleave(function () {
  (0, _jquery.default)("#rightCardBody").html("\n\t<h5 class=\"card-title\">Chemlab</h5>\n\t<h6 class=\"card-subtitle mb-2 text-muted\">Card subtitle</h6>\n\t<p class=\"card-text\">\n\t\tLorem ipsum dolor sit, amet consectetur adipisicing elit. Ex modi quod\n\t\treiciendis nostrum beatae dicta quibusdam ut, temporibus tenetur\n\t\tvoluptatibus odit consectetur doloribus iusto ipsa deserunt nesciunt\n\t\tnobis earum laudantium nemo ratione veniam voluptas in perspiciatis\n\t\taspernatur! Consequuntur pariatur amet voluptatem quasi\n\t\texercitationem, omnis accusantium, eum, in velit saepe deleniti!\n\t</p>");
}); // Removing Startup Animation

setTimeout(function () {
  (0, _jquery.default)(".element").addClass("elementStatic");
  (0, _jquery.default)(".element").removeClass("element");
  (0, _jquery.default)(".elementStatic").css({
    transform: "translateX(-50%) translateY(-50%) scale(1)"
  });
  (0, _jquery.default)(".subElement").addClass("subElementStatic");
  (0, _jquery.default)(".subElement").removeClass("subElement");
  (0, _jquery.default)(".subElementStatic").css({
    opacity: 1
  });
  (0, _jquery.default)(".subElementCategory").css({
    opacity: 0
  });
  (0, _jquery.default)(".animationTrigger").css({
    display: "block"
  });
}, 2500); // Static control
...
if (window.innerWidth <= 699) {
  ...
  (0, _jquery.default)("html").css({
    "font-size": window.innerWidth / 80 + "px"
  });
  (0, _jquery.default)(".subElementCategoryHolder, .subElementCategory, .subElementCategoryIcon").css({
    "z-index": 8
  });
}
},{"bootstrap/dist/css/bootstrap.css":"../node_modules/bootstrap/dist/css/bootstrap.css","bootstrap/dist/js/bootstrap.js":"../node_modules/bootstrap/dist/js/bootstrap.js","jquery":"../node_modules/jquery/dist/jquery.js","./style.scss":"style.scss","animejs":"../node_modules/animejs/lib/anime.es.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
